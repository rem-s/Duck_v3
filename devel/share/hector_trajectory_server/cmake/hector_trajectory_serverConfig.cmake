...
if("TRUE" STREQUAL "TRUE")
  set(hector_trajectory_server_SOURCE_PREFIX /home/rems/Duck_v3/src/hector_slam/hector_trajectory_server)
  set(hector_trajectory_server_DEVEL_PREFIX /home/rems/Duck_v3/devel)
  ...
  set(hector_trajectory_server_INSTALL_PREFIX /home/rems/Duck_v3/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_trajectory_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rems/Duck_v3/src/hector_slam/hector_trajectory_server/${idir}'.  ${_report}")
    endif()
